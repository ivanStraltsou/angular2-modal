...
var BSModalContainer = (function () {
    ...
    BSModalContainer.prototype.ngAfterViewInit = function () {
         ...
         */
        setTimeout(function () {
            _this.dialog.contentRef = index_1.createComponent(_this._cr, _this._compileConfig.component, _this._viewContainer, _this._compileConfig.bindings);
        });
    };
    ...
    BSModalContainer = __decorate([
        ...
        __metadata('design:paramtypes', [index_1.DialogRef, core_1.ElementRef, index_1.ModalCompileConfig, modal_1.Modal, core_1.ComponentFactoryResolver])
    ], BSModalContainer);
    return BSModalContainer;
}());
exports.BSModalContainer = BSModalContainer;
//# sourceMappingURL=C:/_all/_bin/repo/kronos/migration/angular2-modal/src/components/angular2-modal/plugins/bootstrap/modal-container.js.map